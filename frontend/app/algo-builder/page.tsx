      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center text-white">
            <iconify-icon icon="solar:code-linear" width="28"></iconify-icon>
          </div>
          <div>
            <h1 className="text-3xl font-medium tracking-tight text-white mb-1">Algo Bot Builder</h1>
            <p className="text-white/50 text-sm">Institutional-grade intelligence for algo bot builder.</p>
          </div>
        </div>
