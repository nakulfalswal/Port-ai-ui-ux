    ...
    <div className="w-full h-full relative z-10 pt-24 px-8 pb-12">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-medium tracking-tight text-white mb-1">Sector Rotation</h1>
            <p className="text-white/50 text-sm">Institutional-grade intelligence for sector rotation.</p>
          </div>
        </div>
